...
def grade_ex1b(ex1b_answer: dict):
    if (
        ex1b_answer.get("hivqe_energy") > -78.0396545776652
        or ex1b_answer.get("hivqe_energy") < -78.0788722041575
    ):
...
def grade_ex2a(ex2_answer: dict):
    ...
    if (
        not any(2000 <= x < 5000 for x in max_states_list)
        or max(max_states_list) < 5000
    ):
